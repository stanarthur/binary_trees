...
/**
 * insert_node_in_complete_tree - Inserts a node in a complete binary tree.
 ...
 */
	...
	/* it will flip values with pv (parent value) until pv exceeds new value */
 ...
 * @tree: A pointer the root node of a tree to measure the size
 *
